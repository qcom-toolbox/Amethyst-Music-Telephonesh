package com.qcom_toolbox.amethyst_music.ui.screens
...
import com.qcom_toolbox.amethyst_music.AppViewModel
import com.qcom_toolbox.amethyst_music.SortOrder
import com.qcom_toolbox.amethyst_music.data.Playlist
import com.qcom_toolbox.amethyst_music.data.Track
import com.qcom_toolbox.amethyst_music.ui.components.AddToPlaylistDialog
import com.qcom_toolbox.amethyst_music.ui.components.CreatePlaylistDialog
import com.qcom_toolbox.amethyst_music.ui.components.MiniPlayerBar
import androidx.compose.material.icons.filled.Edit
import com.qcom_toolbox.amethyst_music.ui.components.EditTrackDialog
import com.qcom_toolbox.amethyst_music.ui.components.TrackRow
import com.qcom_toolbox.amethyst_music.ui.components.PlayingVisualizer
import com.qcom_toolbox.amethyst_music.ui.theme.AmethystBorder
import com.qcom_toolbox.amethyst_music.ui.theme.AmethystPrimary
import com.qcom_toolbox.amethyst_music.ui.theme.AmethystText
import com.qcom_toolbox.amethyst_music.ui.theme.AmethystTextMuted
...
fun MainScreen(
    ...
    if (showOfflineConfirmation) {
        AlertDialog(
            onDismissRequest = { vm.dismissOfflineConfirmation() },
            title = { Text(stringResource(R.string.connection_lost)) },
            text = { Text(stringResource(R.string.connection_lost)) },
            confirmButton = {
                TextButton(onClick = { vm.confirmOfflineMode() }) {
                    Text(stringResource(R.string.switch_offline))
                }
            },
            dismissButton = {
                TextButton(onClick = { vm.dismissOfflineConfirmation() }) {
    ...
    LaunchedEffect(vm) {
        vm.networkMessages.collectLatest { message ->
